...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('thumbnail', 'product_name', 'price', 'stock', 'is_available', 'slug', 'created_date', 'modified_date')
    ...
    def thumbnail(self, obj):
        if obj.images:
            return format_html('<img src="{}" width="30" style="border-radius:50%;">', obj.images.url)
        return "-"
